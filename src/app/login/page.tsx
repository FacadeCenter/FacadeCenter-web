    ...
    return (
        <div className="min-h-screen bg-black flex flex-col relative">
            ...
            <main className="flex-1 flex items-center justify-center relative z-10">
                <div className="w-full max-w-[1280px] h-auto md:h-[658px] flex flex-col md:flex-row items-center justify-end py-10 md:py-0">
                    {/* Left Section - Empty/Decorative */}
                    <div className="hidden md:block flex-1 h-full" />

                    {/* Right Section - Login Form */}
                    <div className="w-full md:w-[523px] h-full flex flex-col items-end justify-center p-5 md:p-0">
                        <div className="w-full h-auto md:h-[658px] bg-black/[0.004] backdrop-blur-xl border border-white/10 rounded-2xl shadow-[0_4px_12px_rgba(0,0,0,0.5)] flex items-center justify-center px-6 md:px-11 py-8 md:py-5">
                            <div className="w-full max-w-[433px] flex flex-col gap-6">
                                {/* Title */}
                                    ...
                                    <div className="flex flex-col gap-1.5">
                                        ...
                                        <div className="w-full h-[58px] bg-black/[0.004] backdrop-blur-xl border border-white/20 rounded-lg px-4 flex items-center">
                                            <input
                                                ...
                                                className="w-full bg-transparent text-white/90 placeholder:text-white/70 outline-none text-base"
                                            />
                                        </div>
                                    </div>

                                    {/* Sign In Button */}
                                    <button className="w-full h-[49px] bg-white rounded-lg flex items-center justify-center gap-1.5 hover:bg-white/90 transition-all duration-300 hover:scale-[1.02]">
                                ...
                                <div className="flex items-center gap-[18px]">
                                    ...
                                    <span className="text-white/95 text-sm">Sign up with</span>
                                    <div className="flex-1 h-px bg-white/20" />
                                </div>
