...
export function CertificationCTA() {
    return (
        <section className="w-full bg-transparent py-16 md:py-24 flex justify-center">
            <div className="w-full max-w-[1280px] px-6 md:px-[120px] flex flex-col md:flex-row items-center gap-12 md:gap-24">
                {/* Visual Section */}
                <div className="flex-1 w-full max-w-[500px] aspect-square relative order-2 md:order-1">
                ...
                <div className="flex-1 flex flex-col gap-6 order-1 md:order-2">
                    ...
                    <div className="flex flex-wrap gap-4 mt-4">
                        <button className="px-8 py-4 rounded-lg bg-white text-black font-semibold hover:bg-white/90 transition-all">
                            Get Certification
                        </button>
                        <button className="px-8 py-4 rounded-lg bg-transparent text-white border border-white/20 font-semibold hover:bg-white/5 transition-all">
                            View Programs
                        </button>
                    </div>
                </div>
